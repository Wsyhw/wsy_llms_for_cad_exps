...
os.environ["http_proxy"] = "http://192.168.1.111:7890"
os.environ["https_proxy"] = "http://192.168.1.111:7890"
@dataclass
...
def main():
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        print("wsy_debug == full_prompt is: {}".format(full_prompt))
    ...
    if training_args.do_eval:
        ...
        metric = evaluate.load("/home/user/wsy_2024/llms/Llama2-Chinese/train/sft/accuracy.py")
